...
public enum ModArmorMaterials implements ArmorMaterial {
    VALYRIAN_STEEL("valyrian_steel", 24, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.of(ModItems.VALYRIAN_STEEL_INGOT.get()));
    ...
    ModArmorMaterials(String pName, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionTypeMap,
    ...
    public String getName() {
        return WhiteWalkersMod.MOD_ID + ":" + this.name;
    }
